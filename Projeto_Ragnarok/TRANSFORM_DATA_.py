...
df_exploded1 = df_exploded1.withColumn("drop_name",initcap(regexp_replace(col("drop.name"),"_"," ")))
df_selected1 = df_exploded1.select(col("_id").alias('mob_db_id'),
                                 col("monster_id").cast("int"),
                                 col("drop_name"),
                                 col("drop.img").alias("drop_img"),
                                col("drop.rate").cast("float").alias("drop_rate"),
                                 col("element_power").cast("int"))
...
def_spark2 = df_spark2.select(col("_id").alias('mob_db_id'),
                                 col("monster_id").cast("int"),
                                 col("main_atb").getItem("agi").cast("int").alias("mob_agi"),
                                col("main_atb").getItem("int").cast("int").alias("mob_int"),
                                col("main_atb").getItem("luk").cast("int").alias("mob_luk"),
                                col("main_atb").getItem("vit").cast("int").alias("mob_vit"),
                                col("main_atb").getItem("dex").cast("int").alias("mob_dex"))
def_spark2.show()
...
def_spark3 = def_spark3.withColumn('mob_atk_min', split(col('mob_atk'),'~').getItem(0))\
                                    ...
                                    .withColumn("mob_range", regexp_replace(col("mob_range"), "s", ""))\
                                    .withColumn("mob_hp", regexp_replace(col("mob_hp"),",",""))\
                                    .withColumn("mob_base_exp", regexp_replace(col("mob_base_exp"),",",""))\
                                    .withColumn("mob_job_exp", regexp_replace(col("mob_job_exp"),",",""))\
                                    .withColumn("mob_atk_min", regexp_replace(col("mob_atk_min"),",",""))\
                                    .withColumn("mob_atk_max", regexp_replace(col("mob_atk_max"),",",""))\
                                    .drop('mob_def')\
                                    .drop('mob_atk')
#def_spark3.show()
def_spark3 = def_spark3.select(col("mob_db_id"),col("monster_id").cast("int"),col("mob_level").cast("int"),col("mob_hp").cast("int"),col("mob_m_def"),col("mob_range").cast("int"),
                              col("mob_aspd").cast("float"),col("mob_move_speed"),col("mob_base_exp").cast("int"),col("mob_base_xphp").cast("float"),col("mob_job_exp").cast("int"),
                                col("mob_job_xphp").cast("float"),col("mob_hit").cast("int"),col("mob_flee").cast("int"),col("mob_atk_min").cast("int"),col("mob_atk_max").cast("int"),
                               col("mob_def_base").cast("int"),col("mob_def_aditional"))
...
def_spark4 = def_spark4.select(col('_id').alias('mob_db_id'),
                             col('monster_id').cast("int").alias('monster_id'),
                             col('elementalDamage').getItem('neutral').cast("int").alias('mob_element_neutral'),
                             col('elementalDamage').getItem('poison').cast("int").alias('mob_element_poison'),
                             col('elementalDamage').getItem('earth').cast("int").alias('mob_element_earth'),
                             col('elementalDamage').getItem('shadow').cast("int").alias('mob_element_shadow'),
                             col('elementalDamage').getItem('water').cast("int").alias('mob_element_water'),
                             col('elementalDamage').getItem('undead').cast("int").alias('mob_element_undead'),
                             col('elementalDamage').getItem('fire').cast("int").alias('mob_element_fire'),
                             col('elementalDamage').getItem('holy').cast("int").alias('mob_element_holy'),
                             col('elementalDamage').getItem('wind').cast("int").alias('mob_element_wind'),
                             col('elementalDamage').getItem('ghost').cast("int").alias('mob_element_ghost'),
                             )
#def_spark4.show()
...
df_spark6 = df_spark6.withColumn("mob_summoned_by", explode(col("mob_summoned_by")))
df_spark6 = df_spark6.withColumn("mob_summoned_by", initcap(regexp_replace(col("mob_summoned_by"),"_"," ")))
#df_spark6.show()
...
def_spark7 = def_spark7.select(col("mob_db_id"),col("monster_id"),col("amount").cast("int"),col("map_frequency"),col("map_name"),col("map_type"),col("img").alias("map_img"))
